...
`define RegRangeLog2 4:0 // 寄存器数Log2范围（地坢��?
`define WordLength 32 // 字长
`define WordRange 31:0 // 字长范围
`define OpRange 31:26 // 指令字中op的范�?
`define RsRange 25:21 // 指令字中rs的范�?
`define RtRange 20:16 // 指令字中rt的范�?
`define RdRange 15:11 // 指令字中rd的范�?
`define ShamtRange 10:6 // 指令字中shamt的范�?
`define FuncRange 5:0 // 指令字中func的范�?
`define ImmedRange 15:0 // 指令字中immediate的范�?
`define OffsetRange 15:0 // 指令字中offset的范�?
`define AddressRange 25:0 // 指令字中address的范�?
`define DivMulResultRange 63:0 // 乘除法结果范�?高低32位需分开


//外设设备的地坢�（高六位�?
`define IO_SEVEN_DISPLAY 6'b000000  //七段数码�?
`define IO_KEYBORAD 6'b000001  //4*4键盘
`define IO_COUNTER 6'b000010  //计数�?
`define IO_PWM 6'b000011  //PWM控制�?
`define IO_UART 6'b000100  //UART串口
`define IO_WATCH_DOG 6'b000101  //看门�?
`define IO_LED_LIGHT 6'b000110  //led�?
`define IO_SWITCH 6'b000111  //拨码弢��?
`define IO_BUZZER 6'b010001  //蜂鸣�?
